        ...
        function initOwlCarousel(carousel) {
            ...
            for (var j = 0; j < values.length; j++) {
                ...
                for (var k = j; k >= -1; k--) {
                    ...
                    if (!responsive[values[j]]["stagePadding"] &&
            ...
            carousel.owlCarousel({
                autoplay: isNoviBuilder ?
                    false : carousel.attr("data-autoplay") !== "false",
                autoplayTimeout: carousel.attr("data-autoplay") ?
                    Number(carousel.attr("data-autoplay")) : 3000,
            ...
            for (var i = 0; i < plugins.captcha.length; i++) {
                ...
                grecaptcha.render($capthcaItem.attr("id"), {
                    ...
                    size: $capthcaItem.attr("data-size") ?
                        $capthcaItem.attr("data-size") : "normal",
                    theme: $capthcaItem.attr("data-theme") ?
                        $capthcaItem.attr("data-theme") : "light",
                    callback: function(e) {
                    ...
                    var searchItem = $(plugins.search[i]),
                        options = {
                            ...
                            filter: searchItem.attr("data-search-filter") ?
                                searchItem.attr("data-search-filter") : defaultFilter,
                            template: searchItem.attr("data-search-template") ?
                                searchItem.attr("data-search-template") : defaultTemplate,
                            live: searchItem.attr("data-search-live") ?
                                searchItem.attr("data-search-live") : false,
                            liveCount: searchItem.attr("data-search-live-count") ?
                                parseInt(searchItem.attr("data-search-live"), 10) : 4,
                            current: 0,
                            processed: 0,
                            timer: {},
                        };
            ...
            for (i = 0; i < plugins.selectFilter.length; i++) {
                ...
                select.select2({
                    placeholder: select.attr("data-placeholder") ?
                        select.attr("data-placeholder") : false,
