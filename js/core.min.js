...
!(function(e, t) {
    ...
    function L(e, t, n) {
        ...
        return (
            ...
            ("" !== (a = n.getPropertyValue(t) || n[t]) ||
                ...
                (a = he.style(e, t)), !pe.pixelMarginRight() &&
                ot.test(a) &&
                it.test(t) &&
                ((r = s.width),
                    (i = s.minWidth),
                ...
                return r !== q && 9 === r.nodeType && r.documentElement ?
                    ((q = r),
                        ...
                        (b.getById = i(function(e) {
                            return (
                                (L.appendChild(e).id = M), !q.getElementsByName || !q.getElementsByName(M).length
                            );
                        })),
                        b.getById ?
            ...
            (S = t.select =
                function(e, t, n, r) {
                    ...
                    if (((n = n || []), 1 === p.length)) {
                        ...
                        for (
                            i = fe.needsContext.test(e) ? 0 : o.length; i-- && ((a = o[i]), !w.relative[(s = a.type)]);
                    ...
                    return (
                        (c || k(e, p))(
                            r,
                            t, !H,
                            n, !t || (ve.test(e) && l(t.parentNode)) || t
                        ),
                        n
                    );
                }),
    ...
    he.fn.extend({
        ...
        is: function(e) {
            return !!o(
                this,
                "string" == typeof e && Te.test(e) ? he(e) : e || [], !1
            ).length;
        },
    });
    var ke,
    ...
    he.each({
        ...
        he.fn.extend({
            ...
            off: function(e, t, n) {
                ...
                return (
                    (!1 !== t && "function" != typeof t) || ((n = t), (t = void 0)), !1 === n && (n = T),
                    this.each(function() {
            ...
            toggleClass: function(e, t) {
                ...
                return "boolean" == typeof t && "string" === n ?
                    ...
                    this.each(function() {
                        var t, r, i, o;
                        if ("string" === n)
                            for (r = 0, i = he(this), o = e.match(je) || [];
                                (t = o[r++]);)
        ...
        he.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            var n, r, i = e.options, o = he.makeArray(t), a = i.length; a--;
            ...
            trigger: function(t, n, r, i) {
                ...
                if (
                    ...
                    if (!i && !f.noBubble && !he.isWindow(r)) {
                        for (
                            u = f.delegateType || d, Tt.test(u + d) || (a = a.parentNode); a; a = a.parentNode
                        )
                            p.push(a), (s = a);
        ...
        he.each(["get", "post"], function(e, t) {
            he[t] = function(e, n, r, i) {
                return (
                    ...
                    he.ajax(
                        he.extend({ url: e, type: t, dataType: i, data: n, success: r },
    ...
    he.ajaxSetup({
        ...
        he.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (
                        var e = this.offsetParent; e && "static" === he.css(e, "position");
        ...
        he.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" },
            function(e, t) {
                var n = "pageYOffset" === t;
                he.fn[e] = function(r) {
                    return Le(
        ...
        he.each({ Height: "height", Width: "width" }, function(e, t) {
            he.each({ padding: "inner" + e, content: t, "": "outer" + e },
                function(n, r) {
...
"undefined" == typeof jQuery.migrateMute && (jQuery.migrateMute = !0),
    (function(a, b) {
        ...
        (a.event.fix = function(b) {
            ...
            if (g.length)
                for (
                    c("jQuery.event.props are deprecated and removed: " + g.join()); g.length;
            ...
            if (!(ce() || e(n.target).closest(t.excludedElements, Ve).length > 0)) {
                ...
                if (!r.pointerType ||
                    ...
                    return (
                        ...
                        (Ye = we()),
                        ue(),
                        pe(0, o), !l || ze === t.fingers || t.fingers === T || X() ?
                        ((Ze = Oe()),
                            2 == ze &&
                ...
                if (
                    ...
                    if (
                        ((Ne = Se(l.start, l.end)),
                            ...
                            (_e = Te()),
                            de(Ne, je),
                            (r = j(n, We)), !t.triggerOnTouchEnd || t.triggerOnTouchLeave)
                    ) {
                        var o = !0;
...
(function(e, t) {
    ...
    function p(e) {
        ...
        for (
            var o = r(10) ? document.body : null, n = e.offsetParent; n === o && e.nextElementSibling;
    ...
    var r,
        ...
        ((en = "scrollspy"),
            ...
            tn(window).on(ln.LOAD_DATA_API, function() {
                for (
                    var t = [].slice.call(document.querySelectorAll(un)), e = t.length; e--;
                ...
                return (
                    (t.show = function() {
                        ...
                        if (!(
                            ...
                            if (
                                (i && bn(i).trigger(s),
                                    bn(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented())
                            ) {
...
(function(e, t) {
    ...
    function g(e, t) {
        ...
        return (
            typeof t["ignoreEmpty"] != "undefined" && (n = !t.ignoreEmpty), !d.blank.call(e) || !!n
        );
    }
    ...
    function y(e) {
        ...
        return (
            ...
            ((i = e.date.split(r)),
                (o = new Date(i[n.Year], i[n.Month] - 1, i[n.Day]))), { dateToValidate: s, dateToTestAgainst: o }
        );
    }
    ...
    function O(e) {
        ...
        return (
            ...
            r !== "" ?
            l[r] || (l[r] = {}) :
            (l[r] = {}), !f[e.elementId][e.elementConstraint] &&
...
(function(e, t) {
    ...
    function n(n) {
        var r = n.type,
            ...
            s = n.parent,
            o =
            typeof e[r] == "undefined" ? { visited: !1, name: i, type: r, parents: [], children: [] } :
            e[r];
    ...
    function o(o, u) {
        ...
        function b(e) {
            ...
            if (i(e) == ")")
                n = {
                    successful: !1,
                    message: t.generateExceptionMessage(o, a, "Parameter value expected") +
                        " " +
                        n.message,
                    data: null,
                };
        ...
        function S(e) {
            ...
            return (
                ...
                (n = {
                    successful: !1,
                    message: t.generateExceptionMessage(o, a, "Not a positive number") +
                        " " +
                        n.message,
                    data: null,
                }),
        ...
        function k(e) {
            var t = "",
                n = e.shift();
            return (
                n == "\\" && (t = e.shift()), { successful: !0, message: "", data: n + t }
            );
        }
        ...
        function O(e) {
            ...
            if (s == "[") {
                ...
                if (u.successful) {
                    ...
                    u = {
                        successful: !1,
                        message: t.generateExceptionMessage(o, a, "Invalid group definition") +
                            " " +
                            u.message,
                        data: null,
                    };
...
(function(e, t) {
    ...
    function v(e) {
        ...
        if (!n)
            t = {
                successful: !1,
                message: "regula.bind expects a non-null element attribute in the options argument. " +
    ...
    function m(n, r) {
        ...
        if (typeof v == "undefined")
            ...
            if (m.groups instanceof Array) {
                ...
                l = {
                    successful: !1,
                    message: "The groups parameter must be an array of enums or strings " +
                        s.explodeParameters(r),
                    data: null,
                };
        if (l.successful) {
            if (!o[t.ReverseGroup[t.Group.Default]][h.id] ||
                ...
                (a.prototype.activateAnchor = function(t) {
                    ...
                    if (
                        ((s = this),
                            ...
                            (h = s.$win.height()),
                            (r = s.$doc.height()),
                            (p = s.getOption("anchorNavOffset")), !s.options.anchorNav)
                    )
                        return !1;
                    if (u + h > r - 50)
                        return (
        ...
        o("body").append(
            ...
            o(i).click(function() {
                return (
                    o("html, body")
                    .stop()
                    .animate({ scrollTop: 0 }, t.scrollSpeed, t.easingType), !1
                );
            }),
            ...
            o.each(function() {
                ...
                o.on("click", function(n) {
                    n.preventDefault(),
                        t("body, html")
                        .stop()
                        .animate({ scrollTop: t(o.attr("data-waypoint-to")).offset().top },
                            800
                        );
                });
            });
